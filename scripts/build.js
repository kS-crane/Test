...
console.log(' Construction de @banque-centrale-galactique/taux-change...');
...
const banner = `/**
 * @banque-centrale-galactique/taux-change v3.2.1
 * SDK de conversion de devises interplanétaires
 * (c) Banque Centrale Galactique S.A. — Licence MIT
 * Cycle solaire 2184
 */\n\n`;
